  ...
  return (
    <div
      ...
      style={{
        ...
        borderRight: isMobile ? 'none' : '1px solid rgba(124,58,237,0.2)',
        zIndex: 50,
        display: 'flex',
        flexDirection: 'column',
        overflow: 'hidden',
        transform: isOpen ? 'translateX(0)' : `translateX(-${sidebarWidth})`,
        transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
      }}
    >
      {/* Header */}
      <div style={{
        padding: isMobile ? '18px 20px 14px' : '20px 20px 16px',
      ...
      <div style={{
        ...
        flexShrink: 0,
        // Safe area padding for phones with bottom bars (iPhone notch etc.)
        paddingBottom: isMobile ? '28px' : '14px',
      }}>
        <div style={{
          fontSize: '10px',
